...
const AgentChatBox = () => {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-20 w-16 h-16 bg-gradient-to-r from-accent-yellow to-yellow-400 text-white rounded-full shadow-2xl hover:shadow-3xl hover:scale-110 transition-all duration-300 z-40 group"
        title="Chat with Agent"
      >
        <MessageCircle className="h-7 w-7 mx-auto group-hover:rotate-12 transition-transform duration-300" />
  ...
  return (
    <>
      ...
      {/* Chat Interface */}
      <div className="fixed bottom-0 right-0 lg:bottom-6 lg:right-6 w-full h-full lg:w-96 lg:h-[600px] bg-white rounded-none lg:rounded-xl shadow-2xl z-50 flex flex-col border lg:border-gray-200">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-primary-green to-green-600 text-white rounded-none lg:rounded-t-xl">
        ...
        {/* Input Area */}
        <div className="p-4 border-t bg-white rounded-none lg:rounded-b-xl">
